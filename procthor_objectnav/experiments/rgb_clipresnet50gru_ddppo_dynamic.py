...
from .base import DynamicProcTHORObjectNavBaseConfig
from allenact.utils.experiment_utils import Builder


class DynamicProcTHORObjectNavRGBClipResNet50PPOExperimentConfig(DynamicProcTHORObjectNavBaseConfig):
