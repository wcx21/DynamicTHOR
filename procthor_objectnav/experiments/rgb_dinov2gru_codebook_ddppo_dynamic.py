...
from procthor_objectnav.experiments.rgb_dinov2gru_ddppo_dynamic import DynamicProcTHORObjectNavRGBDINOv2PPOExperimentConfig


class DynamicProcTHORObjectNavRGBDINOv2PPOCodebookExperimentConfig(DynamicProcTHORObjectNavRGBDINOv2PPOExperimentConfig):
