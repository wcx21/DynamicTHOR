...
from procthor_objectnav.tasks.object_nav import (
    ...
    DynamicProcTHORObjectNavTestTaskSampler,
)
...
class DynamicProcTHORObjectNavBaseConfig(ExperimentConfig, ABC):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        if self.EVALUATE:
            ...
            # )
            self.EVAL_TASKS = {'test':[i for i in range(50)]}
        else:
    ...
    def make_sampler_fn(
        ...
        if self.EVALUATE:
            ...
            return DynamicProcTHORObjectNavTestTaskSampler(args=task_sampler_args)
        else:
